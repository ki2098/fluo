    ...
    for (int i = GUIDE - 1; i < dom.size[0] - GUIDE; i ++) {
        for (int j = GUIDE - 1; j < dom.size[1] - GUIDE; j ++) {
            for (int k = GUIDE - 1; k < dom.size[2] - GUIDE; k ++) {
                ...
                if (j >= GUIDE && k >= GUIDE) {
                    m3 = Util::ibsee(ff, Cell::Me, Util::Mask1);
                    f3 = Util::ibsee(ff, Cell::Fe, Util::Mask8);
                ...
                if (i >= GUIDE && k >= GUIDE) {
                    m3 = Util::ibsee(ff, Cell::Mn, Util::Mask1);
                    f3 = Util::ibsee(ff, Cell::Fn, Util::Mask8);
                    if (Util::ibsee(u.bflag[f3], BB::uu_locked, Util::Mask1)) {
                ...
                if (i >= GUIDE && j >= GUIDE) {
                    m3 = Util::ibsee(ff, Cell::Mt, Util::Mask1);
                    f3 = Util::ibsee(ff, Cell::Ft, Util::Mask8);
                    if (Util::ibsee(u.bflag[f3], BB::uu_locked, Util::Mask1)) {
        ...
        for (int j = GUIDE; j < dom.size[1] - GUIDE; j ++) {
            for (int k = GUIDE; k < dom.size[2] - GUIDE; k++) {
                if (Util::ibsee(f.m[id3(i,j,k,f.size)], Cell::Active, Util::Mask1)) {
                    ...
                    unsigned w13, w23, w33;
                    unsigned w12, w22, w32;
                    int epe, epn, ept;
                    int epw, eps, epb;
                    real_t u1, u2, u3, mag;
                    ...
                    m11 = Util::ibsee(f11, Cell::Me, Util::Mask1);
                    m12 = Util::ibsee(f12, Cell::Me, Util::Mask1);
                    m13 = Util::ibsee(f13, Cell::Me, Util::Mask1);
                    m14 = Util::ibsee(f14, Cell::Me, Util::Mask1);
                    m21 = Util::ibsee(f21, Cell::Mn, Util::Mask1);
                    m22 = Util::ibsee(f22, Cell::Mn, Util::Mask1);
                    m23 = Util::ibsee(f23, Cell::Mn, Util::Mask1);
                    m24 = Util::ibsee(f24, Cell::Mn, Util::Mask1);
                    m31 = Util::ibsee(f31, Cell::Mt, Util::Mask1);
                    m32 = Util::ibsee(f32, Cell::Mt, Util::Mask1);
                    m33 = Util::ibsee(f33, Cell::Mt, Util::Mask1);
                    m34 = Util::ibsee(f34, Cell::Mt, Util::Mask1);
                    f11 = Util::ibsee(f11, Cell::Fe, Util::Mask8);
                    f12 = Util::ibsee(f12, Cell::Fe, Util::Mask8);
                    f13 = Util::ibsee(f13, Cell::Fe, Util::Mask8);
                    f14 = Util::ibsee(f14, Cell::Fe, Util::Mask8);
                    f21 = Util::ibsee(f21, Cell::Fn, Util::Mask8);
                    f22 = Util::ibsee(f22, Cell::Fn, Util::Mask8);
                    f23 = Util::ibsee(f23, Cell::Fn, Util::Mask8);
                    f24 = Util::ibsee(f24, Cell::Fn, Util::Mask8);
                    f31 = Util::ibsee(f31, Cell::Ft, Util::Mask8);
                    f32 = Util::ibsee(f32, Cell::Ft, Util::Mask8);
                    f33 = Util::ibsee(f33, Cell::Ft, Util::Mask8);
                    f34 = Util::ibsee(f34, Cell::Ft, Util::Mask8);
                    ...
                    w12 = Util::ibsee(u.bflag[f12], BB::wall_func, Util::Mask1);
                    w13 = Util::ibsee(u.bflag[f13], BB::wall_func, Util::Mask1);
                    w22 = Util::ibsee(u.bflag[f22], BB::wall_func, Util::Mask1);
                    w23 = Util::ibsee(u.bflag[f23], BB::wall_func, Util::Mask1);
                    w32 = Util::ibsee(u.bflag[f32], BB::wall_func, Util::Mask1);
                    w33 = Util::ibsee(u.bflag[f33], BB::wall_func, Util::Mask1);
                    epe = (b13)? 0 : 1;
                    epn = (b23)? 0 : 1;
                    ept = (b33)? 0 : 1;
                    epw = (b12)? 0 : 1;
                    eps = (b22)? 0 : 1;
                    epb = (b32)? 0 : 1;
                    de1 = dw1 = 0.5 * sz.m[id4(i,j,k,0,sz.size)];
                    dn1 = ds1 = 0.5 * sz.m[id4(i,j,k,1,sz.size)];
                    dt1 = db1 = 0.5 * sz.m[id4(i,j,k,2,sz.size)];

                    if (w13) {
                        ute = Scheme::wall_function(mag, de1, c.flow.re, c.flow.ri);
                    }
                    if (w23) {
                        utn = Scheme::wall_function(mag, dn1, c.flow.re, c.flow.ri);
                    }
                    if (w33) {
                        utt = Scheme::wall_function(mag, dt1, c.flow.re, c.flow.ri);
                    }
                    if (w12) {
                        utw = Scheme::wall_function(mag, dw1, c.flow.re, c.flow.ri);
                    }
                    if (w22) {
                        uts = Scheme::wall_function(mag, ds1, c.flow.re, c.flow.ri);
                    }
                    if (w32) {
                        utb = Scheme::wall_function(mag, db1, c.flow.re, c.flow.ri);
                    }
...
void MMAC::calc_rhs(scalar_field<real_t> &div, Dom &dom) {
    Ctrl                   &c = dom.c;
    scalar_field<unsigned> &f = dom.f;
    scalar_field<real_t>  &ja = dom.ja;
    vector_field<real_t>   &g = dom.g;
    ...
    vector_field<real_t>   &x = dom.x;
    #pragma acc kernels loop independent collapse(3) present(this[0:1], psi, div, f, , ja, g, p, x, c, dom)
    for (int i = GUIDE; i < dom.size[0] - GUIDE; i ++) {
        for (int j = GUIDE; j < dom.size[1] - GUIDE; j ++) {
            for (int k = GUIDE; k < dom.size[2] - GUIDE; k ++) {
                if (Util::ibsee(f.m[id3(i,j,k,f.size)], Cell::Active, Util::Mask1)) {
                    ...
                    real_t xfe, xfw, yfn, yfs, zft, zfb;
                    xfe = x.m[id4(i+1,j,k,0,x.size)] - x.m[id4(i  ,j,k,0,x.size)];
                    xfw = x.m[id4(i  ,j,k,0,x.size)] - x.m[id4(i-1,j,k,0,x.size)];
                    yfn = x.m[id4(i,j+1,k,1,x.size)] - x.m[id4(i,j  ,k,1,x.size)];
                    yfs = x.m[id4(i,j  ,k,1,x.size)] - x.m[id4(i,j-1,k,1,x.size)];
                    zft = x.m[id4(i,j,k+1,2,x.size)] - x.m[id4(i,j,k  ,2,x.size)];
                    zfb = x.m[id4(i,j,k  ,2,x.size)] - x.m[id4(i,j,k-1,2,x.size)];
                    real_t bce, bcn, bct, bcw, bcs, bcb;
                    bce = p.b[f13];
                    bcn = p.b[f23];
                    bct = p.b[f33];
                    bcw = p.b[f12];
                    ...
                    rhs -= (g1c + g1e) * (feN * xfe + 2 * feD) * bce;
                    rhs += (g1c + g1w) * (fwN * xfw - 2 * fwD) * bcw;
                    rhs -= (g2c + g2n) * (fnN * yfn + 2 * fnD) * bcn;
                    rhs += (g2c + g2s) * (fsN * yfs - 2 * fsD) * bcs;
                    rhs -= (g3c + g3t) * (ftN * zft + 2 * ftD) * bct;
                    rhs += (g3c + g3b) * (fbN * zfb - 2 * fbD) * bcb;
                    rhs /= (2 * det);
                    rhs += div.m[id3(i,j,k,div.size)] / c.time.dt;
                    psi.m[id3(i,j,k,psi.size)] = rhs;
                }
            }
        }
    }
